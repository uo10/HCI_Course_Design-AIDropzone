...
### 3.0 悬浮球胶囊化（临场感 · P0 已实现）

- 计划文档：[悬浮球胶囊化与临场感计划.md](./悬浮球胶囊化与临场感计划.md)
- P0：`dragenter` 胶囊扩窗、吞咽、球内解析进度/闪光、拖入不自动开面板（P1：50px 磁吸等）
...
| 文档 | 用途 |
|------|------|
| [悬浮球胶囊化与临场感计划.md](./悬浮球胶囊化与临场感计划.md) | 小球 Morphing / 非模态投放（待 P0 开发） |
